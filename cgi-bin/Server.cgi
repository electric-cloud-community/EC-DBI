...
# Server.cgi -
#
# Get/set EC-DBI configuration info for UI
#
...
################################
# getCfgList - Return the list of configurations from DBI
#
# Arguments:
#   -
#
...
sub getCfgList {
    ...
    my $gcfg = new ElectricCommander::PropDB($::ec,"/projects/@PLUGIN_NAME@/Server_cfgs");
    ...
    foreach my $cfg (keys  %cfgs) {
      #  my $url = $gcfg->getCol("$cfg/Server_url");
        $xml .= "  <cfg>\n";
        $xml .= "     <name>$cfg</name>\n";
