...
//
// ServerConfigList.java is part of ElectricCommander.
//
...
public class ServerConfigList
{
    ...
    private final Map<String, ServerConfigInfo> m_configInfo =
        new TreeMap<String,  ServerConfigInfo>();
    ...
    public void addConfig(
            ...
            String configUrl)
    {
        m_configInfo.put(configName, new ServerConfigInfo(configUrl));
    }
    ...
    private class ServerConfigInfo
    {
        ...
        public ServerConfigInfo(String url)
        {
            m_url = url;
        }
    }
