    ...
    extends ListBase
{
    ...
    public ConfigurationList()
    {
        ...
        super("ecgc", "Server Configurations", "All Configurations");
        m_configList = new ServerConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        Loader loader = new ServerConfigListLoader(m_configList, this,
                new ChainedCallback() {
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            ClickHandler dch = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the Server configuration '"
                            + configName + "'?") {
